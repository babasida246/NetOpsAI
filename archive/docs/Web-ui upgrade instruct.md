Dưới đây là prompt chi tiết cho GitHub Copilot (Claude Opus 4.5) để fix và nâng cấp giao diện NetOpsAI:

```markdown
# NetOpsAI - UI MIGRATION & MODERNIZATION

## Context
Migrating from Argon Design System to Material Tailwind v2.x with modern Web 3.0 components. Current application is a NetOpsAI with multiple modules: Dashboard, AI Chat, Routing Simulator, Tool Registry, Deployment Health, etc.
