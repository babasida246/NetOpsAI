...
(expected_checkin_date) 
    WHERE status IN
('checked_out', 'partially_returned') AND expected_checkin_date < CURRENT_DATE;
...
VALUES
    ('a0000001-0001-0001-0001-000000000001', 'ACC-MOUSE', 'Chuột', 'Chuột máy tính các loại', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000002', 'ACC-KEYBOARD', 'Bàn phím', 'Bàn phím các loại', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000003', 'ACC-ADAPTER', 'Adapter/Sạc', 'Adapter nguồn, sạc laptop', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000004', 'ACC-CABLE', 'Cáp kết nối', 'Cáp HDMI, USB, DisplayPort...', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000005', 'ACC-HEADSET', 'Tai nghe', 'Tai nghe, headset', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000006', 'ACC-WEBCAM', 'Webcam', 'Webcam, camera', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000007', 'ACC-STORAGE', 'Ổ cứng ngoài', 'Ổ cứng di động, USB', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000008', 'ACC-STAND', 'Giá đỡ', 'Giá đỡ laptop, màn hình', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000009', 'ACC-DOCK', 'Docking station', 'Docking station, hub USB', '00000000-0000-0000-0000-000000000001'),
    ('a0000001-0001-0001-0001-000000000010', 'ACC-OTHER', 'Phụ kiện khác', 'Các phụ kiện khác', '00000000-0000-0000-0000-000000000001')
ON CONFLICT
(code) DO NOTHING;

-- Default manufacturers
INSERT INTO accessory_manufacturers
    (id, code, name, website, created_by)
VALUES
    ('b0000001-0001-0001-0001-000000000001', 'MFR-LOGITECH', 'Logitech', 'https://www.logitech.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000002', 'MFR-MICROSOFT', 'Microsoft', 'https://www.microsoft.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000003', 'MFR-DELL', 'Dell', 'https://www.dell.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000004', 'MFR-HP', 'HP', 'https://www.hp.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000005', 'MFR-LENOVO', 'Lenovo', 'https://www.lenovo.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000006', 'MFR-APPLE', 'Apple', 'https://www.apple.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000007', 'MFR-ANKER', 'Anker', 'https://www.anker.com', '00000000-0000-0000-0000-000000000001'),
    ('b0000001-0001-0001-0001-000000000008', 'MFR-SAMSUNG', 'Samsung', 'https://www.samsung.com', '00000000-0000-0000-0000-000000000001')
ON CONFLICT
(code) DO NOTHING;
