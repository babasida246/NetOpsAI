...
CREATE INDEX ix_approvals__entity_type__entity_id__step_no ON approvals(entity_type, entity_id, step_no);
CREATE INDEX ix_approvals__approver_id__decided_at ON approvals(approver_id, decided_at);
...
CREATE INDEX idx_consumption_logs_model ON asset_consumption_logs(model_id, consumption_date DESC);
...
CREATE INDEX idx_purchase_plan_docs_status ON purchase_plan_docs(status, doc_date DESC);
CREATE INDEX idx_purchase_plan_docs_org ON purchase_plan_docs(org_unit_id, fiscal_year);
...
CREATE INDEX idx_purchase_plan_lines_doc ON purchase_plan_lines(doc_id, line_no);
CREATE INDEX idx_purchase_plan_lines_model ON purchase_plan_lines(model_id);
...
CREATE INDEX idx_asset_increase_docs_status ON asset_increase_docs(status, doc_date DESC);
CREATE INDEX idx_asset_increase_docs_vendor ON asset_increase_docs(vendor_id);
...
CREATE INDEX idx_asset_increase_lines_doc ON asset_increase_lines(doc_id, line_no);
CREATE INDEX idx_asset_increase_lines_asset ON asset_increase_lines(asset_id);
