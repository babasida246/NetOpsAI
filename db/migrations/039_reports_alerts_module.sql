...
-- License alerts
('ALR-LIC-001', 'License Expiring Soon', 'Alert when license expires within 30 days', 'license', 'expiry_date', 'lte', '{"days": 30}', 'warning', 'both', 'once', 168),
('ALR-LIC-002', 'License Expired', 'Alert when license has expired', 'license', 'expiry_date', 'lt', '{"days": 0}', 'critical', 'both', 'daily', 24),
('ALR-LIC-003', 'License Over-Seat', 'Alert when license seats exceeded', 'license', 'seats_used', 'gt', '{"field": "seats_allowed"}', 'critical', 'both', 'once', 4),
('ALR-LIC-004', 'License High Usage', 'Alert when license usage exceeds 90%', 'license', 'usage_percent', 'gte', '{"percent": 90}', 'warning', 'email', 'weekly', 168),

-- Warranty alerts
('ALR-WAR-001', 'Warranty Expiring Soon', 'Alert when warranty expires within 30 days', 'warranty', 'warranty_expiry', 'lte', '{"days": 30}', 'warning', 'both', 'once', 168),
('ALR-WAR-002', 'Warranty Expired', 'Alert when warranty has expired', 'warranty', 'warranty_expiry', 'lt', '{"days": 0}', 'info', 'in_app', 'once', 720),

-- Stock alerts
('ALR-STK-001', 'Accessory Low Stock', 'Alert when accessory below minimum quantity', 'stock', 'quantity', 'lte', '{"field": "min_quantity"}', 'warning', 'both', 'daily', 24),
('ALR-STK-002', 'Consumable Low Stock', 'Alert when consumable below reorder point', 'stock', 'quantity', 'lte', '{"field": "reorder_point"}', 'warning', 'both', 'daily', 24),
('ALR-STK-003', 'Out of Stock', 'Alert when item is out of stock', 'stock', 'quantity', 'eq', '{"value": 0}', 'critical', 'both', 'once', 4),

-- Checkout alerts
('ALR-CHK-001', 'Checkout Due Soon', 'Alert when checkout due within 3 days', 'checkout', 'expected_return', 'lte', '{"days": 3}', 'warning', 'both', 'once', 48),
('ALR-CHK-002', 'Checkout Overdue', 'Alert when checkout is overdue', 'checkout', 'expected_return', 'lt', '{"days": 0}', 'critical', 'both', 'daily', 24),

-- Depreciation alerts
('ALR-DEP-001', 'Fully Depreciated', 'Alert when asset is fully depreciated', 'depreciation', 'status', 'eq', '{"value": "fully_depreciated"}', 'info', 'in_app', 'once', 720),
('ALR-DEP-002', 'Near Full Depreciation', 'Alert when asset within 3 months of full depreciation', 'depreciation', 'remaining_months', 'lte', '{"months": 3}', 'warning', 'both', 'once', 168)
