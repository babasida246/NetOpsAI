...
CREATE INDEX idx_depreciation_schedules_end_date ON depreciation_schedules(end_date);
CREATE INDEX idx_depreciation_schedules_organization ON depreciation_schedules(organization_id);
...
CREATE INDEX idx_depreciation_entries_schedule ON depreciation_entries(schedule_id);
CREATE INDEX idx_depreciation_entries_asset ON depreciation_entries(asset_id);
CREATE INDEX idx_depreciation_entries_period ON depreciation_entries(period_year, period_month);
CREATE INDEX idx_depreciation_entries_posted ON depreciation_entries(is_posted);
CREATE INDEX idx_depreciation_entries_entry_date ON depreciation_entries(entry_date);
...
CREATE INDEX idx_depreciation_runs_period ON depreciation_runs(period_year, period_month);
CREATE INDEX idx_depreciation_runs_status ON depreciation_runs(status);
CREATE INDEX idx_depreciation_runs_organization ON depreciation_runs(organization_id);
...
CREATE INDEX idx_entries_period_posted ON depreciation_entries(period_year, period_month, is_posted);
CREATE INDEX idx_schedules_ending_soon ON depreciation_schedules(end_date) 
    WHERE status = 'active' AND end_date <= CURRENT_DATE + INTERVAL
'6 months';
