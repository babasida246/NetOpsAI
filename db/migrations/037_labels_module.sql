...
CREATE INDEX idx_label_templates_default ON label_templates(is_default) WHERE is_default = true;
...
CREATE INDEX idx_print_jobs_template ON print_jobs(template_id);
CREATE INDEX idx_print_jobs_status ON print_jobs(status);
CREATE INDEX idx_print_jobs_organization ON print_jobs(organization_id);
...
CREATE INDEX idx_print_job_items_job ON print_job_items(print_job_id);
CREATE INDEX idx_print_job_items_asset ON print_job_items(asset_id);
CREATE INDEX idx_print_job_items_status ON print_job_items(status);
...
CREATE INDEX idx_label_settings_organization ON label_settings(organization_id);
