# NetOpsAI - Deployment Script (Windows PowerShell)
...
Write-Host "🚀 NetOpsAI - Deployment" -ForegroundColor Blue
...
if ($Status -match "unhealthy|Exit") {
    Write-Host "⚠️  Some services may not be healthy" -ForegroundColor Yellow
