...
describe('HealthService', () => {
    ...
    describe('getHealth', () => {
        it('should return healthy status when all services are up', async () => {
            ...
            (mockPool.query as any).mockResolvedValue({ rows: [{ '?column?': 1 }] })
        ...
        it('should return unhealthy status when database is down', async () => {
            ...
            (mockPool.query as any).mockRejectedValue(new Error('Connection refused'))
        ...
        it('should return unhealthy status when redis is down', async () => {
            ...
            (mockRedis.ping as any).mockRejectedValue(new Error('Connection refused'))
