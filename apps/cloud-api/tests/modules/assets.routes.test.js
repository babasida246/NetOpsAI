...
describe('assets routes', () => {
    ...
    it('updates asset data', async () => {
        ...
        expect(response.statusCode).toBe(200);
        expect(assetService.updateAsset).toHaveBeenCalledWith(asset.id, { hostname: 'asset-1' }, expect.objectContaining({ userId: 'user-1' }));
    });
    ...
    it('returns asset with manager role', async () => {
        ...
        expect(response.statusCode).toBe(200);
        expect(assetService.returnAsset).toHaveBeenCalledWith(asset.id, 'Returned', expect.objectContaining({ userId: 'user-1' }));
    });
    it('moves asset with manager role', async () => {
        ...
        expect(response.statusCode).toBe(200);
        expect(assetService.moveAsset).toHaveBeenCalledWith(asset.id, locationId, expect.objectContaining({ userId: 'user-1' }));
    });
...
//# sourceMappingURL=assets.routes.test.js.map