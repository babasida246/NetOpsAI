 ...
 * Assets Module
 * 
 * Core asset operations: CRUD, search, assignments, maintenance.
 */
import { API_BASE, apiJson, authorizedFetch, buildQuery, getAssetHeaders } from '../../core/http-client'
...
export async function createMaintenanceTicket(input: MaintenanceCreateInput): Promise<ApiResponse<MaintenanceTicket>> {
...
export async function closeMaintenanceTicket(ticketId: string, resolution?: string): Promise<ApiResponse<MaintenanceTicket>> {
    return apiJson<ApiResponse<MaintenanceTicket>>(`${API_BASE}/v1/maintenance/${ticketId}/close`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...getAssetHeaders() },
