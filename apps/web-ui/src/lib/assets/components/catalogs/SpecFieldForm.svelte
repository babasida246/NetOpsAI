...
<div class="space-y-4">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      ...
      <Input name="label" bind:value={draft.label} placeholder="Memory Size" />
    </div>
    <div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div>
      <Label class="mb-2">Sort Order</Label>
  ...
  {#if enumTypes.includes(draft.fieldType)}
    <div>
      <Label class="mb-2">Enum Values</Label>
  ...
  {#if stringTypes.includes(draft.fieldType)}
    ...
    <div>
      <Label class="mb-2">Pattern</Label>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <Label class="mb-2">Default Value</Label>
      <Input name="defaultValue" bind:value={draft.defaultValue} placeholder="Optional default value" />
    </div>
    <div>
      <Label class="mb-2">Help Text</Label>
      <Textarea name="helpText" rows={2} bind:value={draft.helpText} placeholder="Describe how to fill this field" />
    </div>
  </div>

  <div>
    <Label class="mb-2">Computed Expression</Label>
