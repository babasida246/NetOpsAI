...
<div class="system-config">
    <div class="step-header">
        ...
        <p>Thiết lập thông tin công ty và cấu hình SMTP (tùy chọn)</p>
    </div>
    ...
    <form onsubmit={async (e) => { e.preventDefault(); await handleNext(); }}>
        ...
        <!-- SMTP Configuration -->
        <div class="form-section">
            <h3>📧 Cấu hình Email SMTP (Tùy chọn)</h3>
            <p class="section-description">Cấu hình máy chủ email để gửi thông báo và reset mật khẩu</p>
            ...
            <div class="form-group">
                <label class="checkbox-label">
                    ...
                    />
                    <span>Sử dụng kết nối an toàn (TLS/SSL)</span>
                </label>
            </div>
        </div>
