...
import type { IOpsAttachmentRepo, IOpsEventRepo, IRepairOrderRepo, IStockDocumentRepo, OpsAttachmentInput, OpsAttachmentRecord, OpsAttachmentEntityType } from '@contracts/shared'
