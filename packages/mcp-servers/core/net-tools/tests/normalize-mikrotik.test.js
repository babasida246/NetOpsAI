...
describe('MikroTik parser', () => {
    it('parses bridge host and neighbor outputs', async () => {
        ...
        const datasets = [
            { deviceId: 'dev-1', datasetType: 'BRIDGE_HOST', items: parseRouterOsDetailOutput(bridgeRaw) },
            { deviceId: 'dev-1', datasetType: 'IP_NEIGHBOR', items: parseRouterOsDetailOutput(neighborRaw) },
            { deviceId: 'dev-1', datasetType: 'LLDP_NEIGHBORS', items: parseRouterOsDetailOutput(lldpRaw) },
            { deviceId: 'dev-1', datasetType: 'IP_ARP', items: parseRouterOsDetailOutput(arpRaw) },
            { deviceId: 'dev-1', datasetType: 'INTERFACE_DETAIL', items: parseRouterOsDetailOutput(ifaceRaw) }
        ];
...
//# sourceMappingURL=normalize-mikrotik.test.js.map